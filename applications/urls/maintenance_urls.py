...
from applications.views import accounts_views, semester_views
from .. import views
...
urlpatterns = [
    ...
    path('import_all_teachers_excel/', views.import_all_teachers_excel, name='import_all_teachers_excel'),
